Code starts in
   ...
   https://github.com/christophernhill/prov-profiles/blob/main/ronin/ubuntu20/all-in-one/nginxcert_automation.sh
   
   
this is typically launched from crontab e.g.

```
ubuntu@ip-10-0-1-234:~$ crontab -l
